    ...
    <main>
      ...
      <section id="home" className="hero">
        <div className="container" style={{textAlign:'center'}}>
          ...
          <p className="lead" style={{color:'#b45309'}}>{data?.tagline || 'Strategic. Credible. Impactful.'}</p>
      ...
      <footer className="footer">© {new Date().getFullYear()} {data?.fullName || 'Your Name'} · Corporate Portfolio</footer>
    </main>
  );
}
