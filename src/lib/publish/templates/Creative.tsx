    ...
    <main>
      ...
      <section id="home" className="hero">
        <div className="container" style={{textAlign:'center'}}>
          ...
          <p className="lead">{data?.tagline || 'Thoughtful, striking, memorable.'}</p>
      ...
      <footer className="footer">© {new Date().getFullYear()} {data?.fullName || 'Your Name'} · Creative Portfolio</footer>
    </main>
  );
}
